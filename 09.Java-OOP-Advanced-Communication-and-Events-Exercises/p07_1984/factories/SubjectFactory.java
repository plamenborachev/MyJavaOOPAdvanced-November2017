...
import p07_1984.contracts.Observable;

import java.lang.reflect.Constructor;
import java.lang.reflect.InvocationTargetException;
import java.util.Arrays;

import static p07_1984.constants.PrimitiveClassesToWrapperClassesMapper.mapToWrapper;
...
public class SubjectFactory {
    ...
    public static Observable create(String inputString) throws IllegalAccessException, InvocationTargetException, InstantiationException, NoSuchMethodException {
        ...
        String className = "p07_1984.models." + type;
