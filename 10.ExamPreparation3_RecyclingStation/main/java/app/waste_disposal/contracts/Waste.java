...
public interface Waste {
    ...
    /**
     * A getter for the waste's volume per kilogram.
     * @return An object of type double specifying the waste's volume per kilogram.
     */
    double getVolumePerKg();

    /**
     * A getter for the waste's weight in kilograms.
     * @return An object of type double specifying the waste's weight.
     */
    double getWeight();
}
